    ...
    <div>
      <div className="flex flex-wrap items-center justify-between gap-4 mb-6">
        <div className="flex items-center gap-3">
          <GitFork className="h-8 w-8 text-green-600" />
                      <h2 className="text-3xl font-bold tracking-tight text-gray-800 dark:text-white">Manajemen Lokasi</h2>
        </div>
      ...
      {farms.length > 0 ? (
        ...
        <div className="text-center py-12 bg-white dark:bg-gray-900/70 rounded-xl shadow-md">
            <p className="text-gray-500 dark:text-gray-400">Belum ada lokasi yang ditambahkan.</p>
            <p className="text-gray-500 dark:text-gray-400 mt-2">Gunakan tombol 'Tambah Lokasi Baru' untuk memulai.</p>
        </div>
      )}
    </div>
  );
